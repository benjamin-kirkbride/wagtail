 ...
 * cheap belt that the 11 blocks and the root config are all present.
 */
...
describe('Puck config invariants', () => {
  ...
  it('registers all 11 blocks and the root config', () => {
    const EXPECTED = [
      'Button',
      'Card',
      'Flex',
    ...
    expect(Object.keys(config.components)).toHaveLength(11);
